...
# Main ETL
# =========================
file_path = "pkrt_final_input.xlsx"
...
try:
    ...
    # =========================
    print("Truncate table pkrt...")
    cur.execute("TRUNCATE TABLE pkrt RESTART IDENTITY;")
    conn.commit()

    # =========================
    # 2. Proses semua sheet otomatis
    # =========================
    all_sheets = ["Nilai PKRT Bulanan", "Nilai PKRT Triwulanan"]
